...
use opcode_lib::health::commands as health_cmds;
...
fn main() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            // Health commands (new)
            health_cmds::health_set_prefs,
            health_cmds::health_get_prefs,
            health_cmds::health_record_action,
            health_cmds::health_next_due,
            health_cmds::health_timeline,
            health_cmds::health_daily_summary,
            health_cmds::health_prune,
        ])
